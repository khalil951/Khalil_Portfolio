  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-16 measure">
      ...
      <ul className="mt-6 flex flex-col gap-2 font-ui">
        {profile.links.email ? (
          <li>
            <a href={`mailto:${profile.links.email}`} className="tap-target text-rubric hover:underline">
              {profile.links.email}
            </a>
          </li>
        ) : null}
        {profile.links.linkedin ? (
          <li>
            <a href={profile.links.linkedin} className="tap-target text-rubric hover:underline">
              LinkedIn
            </a>
          </li>
        ) : null}
        {profile.links.github ? (
          <li>
            <a href={profile.links.github} className="tap-target text-rubric hover:underline">
              GitHub
            </a>
          </li>
        ) : null}
        {profile.links.huggingface ? (
          <li>
            <a href={profile.links.huggingface} className="tap-target text-rubric hover:underline">
              Hugging Face
            </a>
          </li>
        ) : null}
