...
| II | **The Path** — *Experience & career timeline* | Experience | Vertical timeline read like a chronology (newest first): 2.1 RFC — AI Engineer Intern · 2.2 Happy City Hub — Researcher · 2.3 Talan Tunisie — Research Software Engineer Intern · 2.4 FelCloud — Data Analyst Intern · 2.5 Attijari Bank — Data Entry Intern *(entries decided 2026-09-24; UGRAD lives in Ch. V, EstateMind in Ch. III)* | `02-profile.md` |
| III | **Systems I Have Built** — *Featured work* | Featured projects | One section per case study: 3.1 Xpress PPM Agent · 3.2 AgriSense AI · 3.3 AI Research Assistant · 3.4 EstateMind | `03-projects.md` (tier: featured) |
...
| V | **Foundations** | Education & skills | 5.1 ESPRIT (Data Science engineering) · 5.2 Global UGRAD, UNC Greensboro · 5.3 Toolkit (skills grouped; each links to the Index) | `02-profile.md` |
| VI | **Recognition & Community** | Awards & leadership | 6.1 Talan Innovation Summer Camp — 1st place · 6.2 Intelligent Planet Hackathon · 6.3 AIESEC oGT Team Leader | `02-profile.md` |
| VII | **Open Questions** — *What I'm studying now* | "Now" / curiosity | Short entries, each framed as a question: How does PagedAttention change serving economics? Why does GRPO favour long answers? What is autograd actually computing (VJPs)? | `02-profile.md` → Currently exploring |
